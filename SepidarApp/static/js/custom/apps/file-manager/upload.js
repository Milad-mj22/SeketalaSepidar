        ...
        var myDropzone = new Dropzone(id, {
            ...
            sending: function(file, xhr, formData) {
                ...
                if (currentDatasetName) {
                    formData.append('dataset_name', currentDatasetName);
                }
                
                console.log('Sending with dataset_id:', currentDatasetId, 'dataset_name:', currentDatasetName);
            },
