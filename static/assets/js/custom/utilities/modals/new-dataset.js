...
var KTModalNewDataset = function () {
    var submitButton;
    var cancelButton;
    var validator;
    var form;
    ...
    return {
        init: function () {
            modalEl = document.querySelector('#new_dataset');
            if (!modalEl) {
            ...
            form = document.querySelector('#new_dataset_form');
            submitButton = document.getElementById('new_dataset_submit');
            cancelButton = document.getElementById('new_dataset_cancel');
